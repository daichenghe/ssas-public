...
set MSYS2=D:\soft_install\MSYS2
...
set PATH=D:\soft_install\anaconda3;D:\soft_install\anaconda3\Scripts;%MSYS2%\mingw64\bin;%MSYS2%\usr\bin;%MSYS2%\mingw32\bin;%PATH%
